...
class Odf {
     ...
     * @return odf
     */
    public function setVars($key, $value, $encode = true, $charset = 'ISO-8859', $reportarError = TRUE) {
     ...
     * @param real $width in centimeters 
     * @param real $height in centimeters 
     * @throws OdfException
     * @return Segment
     */
