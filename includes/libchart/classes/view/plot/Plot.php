...
class Plot {
    ...
    public function drawBorders() {
        ...
        imagerectangle($this->img, 1, 0, $this->width - 1, 0, $this->backGroundColor->getColor($img));
        imagerectangle($this->img, 1, $this->height - 1, $this->width - 1, $this->height - 1, $this->backGroundColor->getColor($img));
        imagerectangle($this->img, 1, 1, 1, $this->height - 1, $this->backGroundColor->getColor($img));
        imagerectangle($this->img, $this->width - 1, 1, $this->width - 1, $this->height - 1, $this->backGroundColor->getColor($img));
    }
